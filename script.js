        ...
        // Typing animation
        const phrases = ['Front-End Developer', 'Responsive UI Builder', 'Web Performance Enthusiast'];
        let phraseIndex = 0;
        let charIndex = 0;
...
//skill dock animation
  ...
  skillItems.forEach((item) => {
    item.addEventListener('mousemove', (e) => {
      ...
      item.style.transform = `translateY(-10px) scale(1.2) rotateX(${ -rotateX }deg) rotateY(${ rotateY }deg)`;
    });
